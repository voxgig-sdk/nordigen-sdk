...
func plClient(t *testing.T, sdkopts map[string]any) (*sdk.NordigenSDK, *sdk.Utility) {
	t.Helper()
	client := sdk.TestSDK(nil, sdkopts)
	return client, client.GetUtility()
}

func plCtx(client *sdk.NordigenSDK, utility *sdk.Utility, ctrl map[string]any) *sdk.Context {
