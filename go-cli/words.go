...
func registerSDKWords(r *eng.Registry, client *sdk.NordigenSDK) {
...
func runOp(client *sdk.NordigenSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
