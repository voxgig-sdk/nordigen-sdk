...
(0, node_test_1.describe)('InstitutionEntity', async () => {
    ...
    // `test.live.delayMs`; only sleeps when NORDIGEN_TEST_LIVE=TRUE.
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('NORDIGEN_TEST_LIVE'));
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.NordigenSDK.test();
        const ent = testsdk.Institution();
        (0, node_assert_1.default)(null != ent);
    });
    (0, node_test_1.test)('basic', async (t) => {
        const live = 'TRUE' === process.env.NORDIGEN_TEST_LIVE;
...
function basicSetup(extra) {
    ...
    let client = __1.NordigenSDK.test(options, extra);
    ...
    const idmapEnvVal = process.env['NORDIGEN_TEST_INSTITUTION_ENTID'];
    ...
    if (live) {
        client = new __1.NordigenSDK(merge([
            {
