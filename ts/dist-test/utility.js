...
function envOverride(m) {
    if ('TRUE' === process.env.NORDIGEN_TEST_LIVE ||
        'TRUE' === process.env.NORDIGEN_TEST_OVERRIDE) {
    ...
    m.NORDIGEN_TEST_EXPLAIN = process.env.NORDIGEN_TEST_EXPLAIN || m.NORDIGEN_TEST_EXPLAIN;
    return m;
}
