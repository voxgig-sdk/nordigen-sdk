...
// Nordigen SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NordigenMakeRequest
{
    public static function call(NordigenContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NordigenResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NordigenResponse($fetched);
        } else {
