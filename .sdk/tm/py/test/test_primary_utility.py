# Nordigen SDK primary utility test
...
from projectname_sdk import NordigenSDK
from projectname_sdk.core.spec import NordigenSpec
from projectname_sdk.core.result import NordigenResult
from projectname_sdk.core.response import NordigenResponse
from projectname_sdk.core.operation import NordigenOperation
from projectname_sdk.core.error import NordigenError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import NordigenBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = NordigenSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = NordigenSDK.test(None, None)
        ...
        class TestInitFeature(NordigenBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(NordigenBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = NordigenSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = NordigenSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = NordigenSDK.test(None, setup_opts)
