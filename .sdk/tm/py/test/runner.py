...
class NordigenTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NordigenTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = NordigenTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = NordigenTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
