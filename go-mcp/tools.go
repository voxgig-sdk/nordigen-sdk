...
type Args struct {
	Entity string         `json:"entity" jsonschema:"institution"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.NordigenSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "nordigen_list",
		Description: "List records from Nordigen. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "nordigen_load",
		Description: "Load a single record from Nordigen. " +
...
func runOp(client *sdk.NordigenSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.NordigenSDK, name string) (sdk.NordigenEntity, error) {
	switch strings.ToLower(name) {
	case "institution":
		return client.Institution(nil), nil
