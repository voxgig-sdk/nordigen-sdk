...
from nordigen_sdk.utility import register

# Load features
from nordigen_sdk.feature.base_feature import NordigenBaseFeature
from nordigen_sdk.features import _has_feature, _make_feature
...
class NordigenSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = NordigenUtility()
        self._utility = utility

        from nordigen_sdk.config import shared_config
    ...
    def get_utility(self):
        return NordigenUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NordigenSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Institution(self, data=None) -> "InstitutionEntity":
        ...
        from nordigen_sdk.entity.institution_entity import InstitutionEntity
        return InstitutionEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "NordigenSDK":
        if sdkopts is None:
            sdkopts = {}
