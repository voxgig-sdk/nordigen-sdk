...
from nordigen_sdk.core.control import NordigenControl
...
from nordigen_sdk.core.helpers import get_ctx_prop, to_map
...
class NordigenContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, NordigenResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NordigenResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return NordigenError(code, msg, self)
