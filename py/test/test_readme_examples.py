# Nordigen SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NordigenSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NordigenSDK(...) and NordigenSDK.test(...) become
#      NordigenSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "nordigen_sdk"
_SDK_CLASS = "NordigenSDK"
