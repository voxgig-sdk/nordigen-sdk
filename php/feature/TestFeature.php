...
// Nordigen SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class NordigenTestFeature extends NordigenBaseFeature
{
    ...
    public function init(NordigenContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (NordigenContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (NordigenContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(NordigenContext $ctx, $op, $args): array
    {
