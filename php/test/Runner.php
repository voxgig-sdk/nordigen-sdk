...
class NordigenTestRunner
{
    ...
    {
        $live = self::getenv('NORDIGEN_TEST_LIVE');
        $override = self::getenv('NORDIGEN_TEST_OVERRIDE');
        ...
        $explain = self::getenv('NORDIGEN_TEST_EXPLAIN');
...
class_alias('NordigenTestRunner', 'Runner');
class_alias('NordigenHelpers', 'Helpers');
