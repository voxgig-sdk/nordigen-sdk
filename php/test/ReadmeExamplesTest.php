...
// Nordigen SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NordigenSDK::test)
...
{
    private const SDK_CLASS = 'NordigenSDK';
    ...
    private const SDK_BASE = 'nordigen_sdk';
