...
require_once __DIR__ . '/../nordigen_sdk.php';
...
{
    private static function utility(): NordigenUtility
    {
        return new NordigenUtility();
    }
    ...
    private static function ctx(array $over = []): NordigenContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new NordigenContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new NordigenOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof NordigenError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new NordigenOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = NordigenMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new NordigenOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = NordigenMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new NordigenOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = NordigenMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NordigenSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = NordigenMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new NordigenResponse([]),
            'result' => new NordigenResult([]),
        ]);
        [, $err] = NordigenMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new NordigenSpec([]),
            'response' => null,
            'result' => new NordigenResult([]),
        ]);
        [, $err] = NordigenMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new NordigenSpec(['step' => 's']),
            'response' => new NordigenResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new NordigenResult([]),
        ]);
        [, $err] = NordigenMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new NordigenSpec(['step' => 's']),
            'response' => new NordigenResponse(self::resp(200, ['v' => 1])),
            'result' => new NordigenResult([]),
        ]);
        [, $err] = NordigenMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new NordigenSpec(['step' => 's']),
            'response' => new NordigenResponse(self::resp(200, ['v' => 2])),
            'result' => new NordigenResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        NordigenMakeResponse::call($ctx);
    ...
    {
        $preset = new NordigenResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new NordigenSpec([]),
            'response' => new NordigenResponse([]),
            'result' => new NordigenResult([]),
        ...
        [$got, $err] = NordigenMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new NordigenResult([])]);
        [, $err] = NordigenMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new NordigenSpec([]), 'result' => null]);
        [, $err] = NordigenMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NordigenSpec(['step' => 's']),
            'result' => new NordigenResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new NordigenOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NordigenMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NordigenSpec(['step' => 's']),
            'result' => new NordigenResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new NordigenOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NordigenMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NordigenResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new NordigenSpec([]),
            'result' => new NordigenResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = NordigenMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NordigenMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new NordigenError('boom', 'boom');
        $utility->fetcher = function (NordigenContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NordigenSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = NordigenMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (NordigenContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = NordigenMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(NordigenResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (NordigenContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NordigenSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = NordigenMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new NordigenResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new NordigenSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = NordigenMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = NordigenMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = NordigenMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new NordigenResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, NordigenDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new NordigenResult(['ok' => false])]);
        $this->expectException(NordigenError::class);
        NordigenDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new NordigenResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', NordigenMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        NordigenMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new NordigenBaseFeature();
        $b = new NordigenBaseFeature();
        NordigenFeatureAdd::call($ctx, $a);
        NordigenFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): NordigenBaseFeature
    {
        $f = new NordigenBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        NordigenFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): NordigenContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new NordigenSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NordigenPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new NordigenResponse(['headers' => null]),
            'result' => new NordigenResult([]),
        ]);
        NordigenResultHeaders::call($ctx);
