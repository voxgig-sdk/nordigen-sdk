...
class NordigenGraphql
{
    ...
    // equivalent.
    public static function body(NordigenContext $ctx): mixed
    {
    ...
    public static function errors(NordigenContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
