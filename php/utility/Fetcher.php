...
// Nordigen SDK utility: fetcher

class NordigenFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NordigenSDK/1.0)';
    ...
    public static function call(NordigenContext $ctx, string $fullurl, array $fetchdef): array
    {
